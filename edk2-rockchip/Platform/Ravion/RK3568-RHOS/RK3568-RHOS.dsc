...
[Defines]
  ...
  BOARD_DXE_FV_COMPONENTS        = Platform/Ravion/RK3568-RHOS/RK3568-RHOS.fdf.inc
...
!endif
  ...
  #
  # Network in UEFI Shell
  #
!if $(RHOS_USE_NETWORK_STACK) == FULL
...
[PcdsFixedAtBuild.common]
  ...
  gRk356xTokenSpaceGuid.PcdPlatformName|"Ravion RK3568-RHOS"
  gRk356xTokenSpaceGuid.PcdCpuName|"Rockchip RK3568 (Cortex-A55)"
  gRk356xTokenSpaceGuid.PcdPlatformVendorName|"Ravion"
  gRk356xTokenSpaceGuid.PcdFamilyName|"RK3568-RHOS"
  gRk356xTokenSpaceGuid.PcdProductUrl|"https://no.site.com/"
  ...
  #
  # _NO_ Limit eMMC to 52 MHz
  #
  gRk356xTokenSpaceGuid.PcdEmmcDxeBaseAddress|0xFE310000
  # gRk356xTokenSpaceGuid.PcdEmmcForceHighSpeed|TRUE

  # FixMe: RTC must be rewriten
...
[Components.common]
  ...
  # Board specific
  #
  Platform/Ravion/RK3568-RHOS/Drivers/BoardInitDxe/BoardInitDxe.inf
  ...
  Platform/Ravion/Logo/LogoDxe.inf
...
#     NULL|ShellPkg/Library/UefiShellNetwork2CommandsLib/UefiShellNetwork2CommandsLib.inf no ipv6
!endif
